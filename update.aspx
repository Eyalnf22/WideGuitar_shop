<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update.aspx.cs" MasterPageFile="~/adminMaster.Master" Inherits="EyalProject.update" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>עדכון משתמשים</title>
</asp:Content>
...
<asp:Button CssClass="send" ID="toInst" runat="server" Style="width:230px;" Text="הוספת כלי" OnClick="toInst_Click" CausesValidation="false"/>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="par">
            ...
            <table class="tbl" border="1" >
                ...
                <tr>
                  <td colspan="2"> 
                      <center>
                       ...
                       <br /><div style="color:<%=msgcolor%>;">  <%= msg %> </div>              
                          <asp:RequiredFieldValidator CssClass="req" ID="Requsername" runat="server" ErrorMessage="שדה חובה" ControlToValidate="usernameBox"></asp:RequiredFieldValidator>
                          </center>
                </td>
                ...
                <tr>
                    ...
                    <td> 
                        עיר:<asp:TextBox  ID="cityBox" runat="server" CssClass="box" ></asp:TextBox>
                    </td>
        ...
        <asp:Button OnClick="updateB_Click" ID="loginB" runat="server" Text="עדכן" style="background-image: radial-gradient(circle, Chartreuse, LawnGreen, Green);" CssClass="send"/>
